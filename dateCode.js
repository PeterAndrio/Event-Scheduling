...
function addNewTime(ele) {
	var id = ele.id ;
	var u = id.split("_");
	var tmpDiv = "<input type='time' style='font-size:1vw' placeholder='Add new time' id='time_" + localStorage.getItem("counterTimes") + "' /><button class='btn btn-sm btn-danger responsive-width' style='font-size:1vw' id='btn_" + localStorage.getItem("counterButtons") + "' onclick='deleteElement(this)'' type='button'>Delete Time</button>";
